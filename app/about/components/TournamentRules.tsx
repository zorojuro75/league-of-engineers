      ...
      <div className="md:h-[404px] md:w-[1280px] px-[32px] mt-[64px]">
        <div className="md:flex md:gap-[32px] md:mb-[64px]">
          <Rules
            ...
            description={
              "Seeking 16 adept leaders to guide each team, with faculty members stepping into the role of managers."
            }
          />
          <Rules
        ...
        <div className="md:flex gap-[32px]">
          ...
          <Rules
            ...
            description={
              "It's time to bid and build! Managers' first picks become icon players, teaming up with faculty to gather the remaining team members using virtual coins"
            }
          />
        </div>
      </div>
